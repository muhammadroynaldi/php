...
<center>
<div class="panjang">
<h3 align="left" style="margin-bottom:30px">Daftar Pelanggan</h3>
<?php
    ...
    while ($row=$hasil->fetch_assoc()){
        ...
        $teks.="<td>".$row["telp"]."</td>";
        $teks.="<td><a
        href='editPlg.php?id=".$row["id"]."'>Edit</a></td>";
        $teks.="<td><a
        href='delPlg.php?id=".$row["id"]."'>Hapus</a></td>";
        $teks.="</tr>";
        echo $teks;
    }
    echo "</table>";
    ...
    color:black;' href='addPlg.php''>Tambah</a></td>
    </tr>";
    echo "</table>";
}
    else {
